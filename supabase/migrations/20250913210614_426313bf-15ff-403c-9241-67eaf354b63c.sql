...
BEGIN
  ...
  INSERT INTO public.plan_features (plan_id, feature_text, display_order) VALUES
  (free_plan_id, '1,000 API calls/month', 1),
  (free_plan_id, 'Basic analytics', 2),
  (free_plan_id, 'Email support', 3),
  (free_plan_id, 'Standard rate limits', 4),
  (free_plan_id, 'Community access', 5);
  
  -- Insert features for Pro plan
  INSERT INTO public.plan_features (plan_id, feature_text, display_order) VALUES
  (pro_plan_id, '100,000 API calls/month', 1),
  (pro_plan_id, 'Advanced analytics', 2),
  (pro_plan_id, 'Priority support', 3),
  (pro_plan_id, 'Higher rate limits', 4),
  (pro_plan_id, 'Webhooks included', 5),
  (pro_plan_id, 'Custom integrations', 6);
  
  -- Insert features for Enterprise plan
  INSERT INTO public.plan_features (plan_id, feature_text, display_order) VALUES
  (enterprise_plan_id, 'Unlimited API calls', 1),
  (enterprise_plan_id, 'Enterprise analytics', 2),
  (enterprise_plan_id, '24/7 dedicated support', 3),
  (enterprise_plan_id, 'Custom rate limits', 4),
  (enterprise_plan_id, 'SLA guarantee', 5),
  (enterprise_plan_id, 'On-premise options', 6),
  (enterprise_plan_id, 'Custom contracts', 7);
END $$;