...
import { Brain, Cpu, Database, ArrowRight, Code, BarChart3, Settings, Users, Zap, FileText, Grid } from "lucide-react";
import { Link, useSearchParams } from "react-router-dom";
import MermaidDiagram from "@/components/ui/mermaid-diagram";
import SAIVisualization from "@/components/visualizations/SAIVisualization";
import EngineManagementDashboard from "@/components/sai/EngineManagementDashboard";
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h1 className="text-4xl font-bold text-foreground">Symbolic AI (SAI)</h1>
                <p className="text-xl text-muted-foreground">Multi-tenant symbolic AI service with prime-based pattern learning and training</p>
              </div>
              <div className="ml-auto">
                <Badge className="bg-emerald-100/70 dark:bg-emerald-900/30 text-emerald-800 dark:text-emerald-200">Production Ready</Badge>
              </div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              <div className="text-center p-6 bg-emerald-50/50 dark:bg-emerald-900/20 rounded-lg">
                <Brain className="h-8 w-8 text-emerald-600 dark:text-emerald-400 mx-auto mb-2" />
                <div className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">Symbolic</div>
              ...
              <div className="text-center p-6 bg-teal-50/50 dark:bg-teal-900/20 rounded-lg">
                ...
                <div className="text-2xl font-bold text-teal-600 dark:text-teal-400">Multi-Tenant</div>
                <div className="text-sm text-muted-foreground">User Isolation</div>
              </div>
              ...
              <div className="text-center p-6 bg-purple-50/50 dark:bg-purple-900/20 rounded-lg">
                <Database className="h-8 w-8 text-purple-600 dark:text-purple-400 mx-auto mb-2" />
                <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">Prime-Based</div>
                <div className="text-sm text-muted-foreground">Symbol Mapping</div>
              </div>
            </div>
          ...
          <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
            ...
            {/* Overview Tab - Existing content + demo */}
            <TabsContent value="overview" className="space-y-8 mt-8">
              ...
              {/* RNET Integration */}
              <div>
                <h2 className="text-3xl font-bold text-foreground mb-8">RNET Integration & Collaboration</h2>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        <div className="bg-emerald-50/50 dark:bg-emerald-900/20 p-4 rounded-lg">
                          <div className="font-mono text-sm">
                            <div className="text-emerald-600 mb-2">// Create collaborative SAI space</div>
                            <pre className="text-foreground">{`const rnetSpace = await rnet.spaces.create({
...
await engine.training.start({
  ...
  shareSymbolMappings: true
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        <div className="bg-teal-50/50 dark:bg-teal-900/20 p-4 rounded-lg">
                          <div className="font-mono text-sm">
                            <div className="text-teal-600 mb-2">// Distributed prime signature learning</div>
                            <pre className="text-foreground">{`const symbolSpace = await rnet.spaces.create({
  name: "shared-symbols",
...
await sai.engines.process({
  ...
  learnFromPeers: true
              ...
              <div>
                <h2 className="text-3xl font-bold text-foreground mb-8">Performance & Enterprise Features</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          <span className="text-sm text-muted-foreground">User Isolation:</span>
                          <span className="font-mono text-sm">Complete</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-sm text-muted-foreground">Data Separation:</span>
                          <span className="font-mono text-sm">Directory</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-sm text-muted-foreground">Resource Pooling:</span>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          <span className="text-sm text-muted-foreground">Symbol Mappings:</span>
                          <span className="font-mono text-sm">Custom</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-sm text-muted-foreground">Prime Config:</span>
                          <span className="font-mono text-sm">Flexible</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-sm text-muted-foreground">Training Params:</span>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          <span className="text-sm text-muted-foreground">Training Metrics:</span>
            ...
            <TabsContent value="management" className="mt-8">
              <EngineManagementDashboard />
            </TabsContent>

            {/* Documentation Tab */}
            <TabsContent value="documentation" className="space-y-8 mt-8">
              {/* System Architecture */}
              <div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          <div>
                            ...
                            <div className="space-y-2 text-sm">
                              <div className="bg-muted p-2 rounded font-mono">POST /api/engines</div>
                              <div className="bg-muted p-2 rounded font-mono">GET /api/engines</div>
                              <div className="bg-muted p-2 rounded font-mono">GET /api/engines/&#123;id&#125;</div>
                              <div className="bg-muted p-2 rounded font-mono">PUT /api/engines/&#123;id&#125;</div>
                              <div className="bg-muted p-2 rounded font-mono">DELETE /api/engines/&#123;id&#125;</div>
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="space-y-2 text-sm">
                              <div className="bg-muted p-2 rounded font-mono">POST /api/engines/&#123;id&#125;/process</div>
                              <div className="bg-muted p-2 rounded font-mono">POST /api/engines/&#123;id&#125;/batch-process</div>
                              <div className="bg-muted p-2 rounded font-mono">GET /api/engines/&#123;id&#125;/symbols</div>
                              <div className="bg-muted p-2 rounded font-mono">POST /api/engines/&#123;id&#125;/symbols</div>
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="space-y-2 text-sm">
                              <div className="bg-muted p-2 rounded font-mono">POST /api/engines/&#123;id&#125;/training/start</div>
                              <div className="bg-muted p-2 rounded font-mono">GET /api/engines/&#123;id&#125;/training/status</div>
                              <div className="bg-muted p-2 rounded font-mono">POST /api/engines/&#123;id&#125;/training/stop</div>
                              <div className="bg-muted p-2 rounded font-mono">GET /api/engines/&#123;id&#125;/training/history</div>
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="space-y-2 text-sm">
                              <div className="bg-muted p-2 rounded font-mono">POST /api/auth/register</div>
                              <div className="bg-muted p-2 rounded font-mono">POST /api/auth/login</div>
                              <div className="bg-muted p-2 rounded font-mono">GET /api/engines/&#123;id&#125;/training-data</div>
                              <div className="bg-muted p-2 rounded font-mono">POST /api/engines/&#123;id&#125;/training-data</div>
                            </div>
                          </div>
                        </div>
                      </CardContent>
              ...
              <Card className="bg-gradient-to-r from-emerald-50/50 to-teal-50/50 dark:from-emerald-900/20 dark:to-teal-900/20 border-emerald-200 dark:border-emerald-800">
                <CardHeader>
